...
| 资产归档与按需历史复用 | `docs/test-design/archive-and-index-guidelines.md`、`docs/test-assets/README.md` | Skill、`AGENTS.md`、`CODEBUDDY.md` | `README.md` |
...
- 资产归档与按需历史复用只在 `archive-and-index-guidelines.md` 中完整描述。
...
| 修改归档或历史复用规则 | `archive-and-index-guidelines.md`、`docs/test-assets/README.md`、校验脚本 | Skill/AGENTS/CODEBUDDY 摘要 |
